...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=ffmpeg --enable-shared --extra-cflags=-I/c/MinGW/include --yasmexe='c:/yasm/yasm-1.3.0-win64.exe' --cpu=i686
prefix=ffmpeg
...
DEPAS=gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=c:/yasm/yasm-1.3.0-win64.exe
DEPYASM=c:/yasm/yasm-1.3.0-win64.exe
AR=ar
ARFLAGS=rcD
AR_O=$@
RANLIB=:
...
CFLAGS=  -I/c/MinGW/include -march=i686 -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/c/MinGW/include -march=i686 -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
EXTRALIBS=-lavicap32 -lgdi32 -lws2_32 -liconv -lm -lz -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
libavfilter_VERSION=6.6.100
libavfilter_VERSION_MAJOR=6
libavfilter_VERSION_MINOR=6
libavformat_VERSION=57.2.100
